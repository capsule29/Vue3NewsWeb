...
declare module '@/api/authority/AuthorityModel.ts'

declare module '@/api/user/index.ts'
declare module '@/api/user/UserModel.ts'

declare module '@/api/news/index.ts'
declare module '@/api/news/NewsModel.ts'
